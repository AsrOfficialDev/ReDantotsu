        ...
        init {
            itemView.setOnClickListener {
                if (0 <= bindingAdapterPosition && bindingAdapterPosition < arr.size)
                    fragment.onNovelChapterClick(arr[bindingAdapterPosition])
            }
        }
    }
        ...
        for (i in 0..<n) {
            if (position + i < arr.size) {
                ...
                if (activeDownloads.contains(chapterNumber)) {
                    ...
                    fragment.onNovelChapterDownloadClick(chapter)
        ...
        init {
            ...
            binding.itemDownload.setOnClickListener {
                if (0 <= bindingAdapterPosition && bindingAdapterPosition < arr.size) {
                    ...
                    val chapterNumber = chapter.uniqueNumber()
                    if (activeDownloads.contains(chapterNumber)) {
                        fragment.onNovelChapterStopDownloadClick(chapter)
                        ...
                        it.context.customAlertDialog().apply {
                            ...
                            setPosButton(R.string.delete) {
                                fragment.onNovelChapterRemoveDownloadClick(chapter)
                            }
